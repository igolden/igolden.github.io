...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jekyll-sitemap>, ["= 0.9.0"])
      ...
      s.add_runtime_dependency(%q<github-pages-health-check>, ["= 0.6.0"])
      s.add_runtime_dependency(%q<jekyll-seo-tag>, ["= 0.1.4"])
      ...
      s.add_dependency(%q<jekyll-sitemap>, ["= 0.9.0"])
      s.add_dependency(%q<jekyll-feed>, ["= 0.3.1"])
      s.add_dependency(%q<jekyll-gist>, ["= 1.4.0"])
      s.add_dependency(%q<jekyll-paginate>, ["= 1.1.0"])
      s.add_dependency(%q<github-pages-health-check>, ["= 0.6.0"])
      s.add_dependency(%q<jekyll-seo-tag>, ["= 0.1.4"])
